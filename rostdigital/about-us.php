...
<body>
    <header>
        ...
        <div class="burger-menu">
            ...
            <nav class="burger-menu_nav">
                ...
                <a href="./about-us.html" class="burger-menu_link">О нас</a>
    ...
    <main>
        <section class="about-us_slider">
            <svg class="logo-shadow" xmlns="http://www.w3.org/2000/svg" width="880.601" height="1028.611" viewbox="0 0 880.601 1028.611">
                <defs>
                    <filter id="Контур_314" width="746.097" height="784.647" x="134.504" y="243.964" filterunits="userSpaceOnUse">
                        <feoffset dx="100" dy="21"/>
                        <fegaussianblur result="blur" stddeviation="49.5"/>
            ...
            <span class="Rost-Digital">rost digital</span>
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">Мы цифровые мыслители, создатели и деятели, которые дальше продвигают бренды Мы цифровые мыслители, создатели и деятели, которые дальше продвигают бренды</div>
                    <div class="swiper-slide">Мы цифровые мыслители, создатели и деятели, которые дальше продвигают бренды Мы цифровые мыслители, создатели и деятели, которые дальше продвигают бренды</div>
                    <div class="swiper-slide">Мы цифровые мыслители, создатели и деятели, которые дальше продвигают бренды Мы цифровые мыслители, создатели и деятели, которые дальше продвигают бренды</div>
                    <div class="swiper-slide">Мы цифровые мыслители, создатели и деятели, которые дальше продвигают бренды Мы цифровые мыслители, создатели и деятели, которые дальше продвигают бренды</div>
                </div>
            ...
            <a href="#here">
                <div class="down">
                    ...
                    <svg class="arrow" xmlns="http://www.w3.org/2000/svg" width="43" height="44" viewbox="0 0 43 44">
                <defs>
                    <filter id="ddlt3zc88a" width="43" height="44" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset dx="2" dy="5"/>
                        <fegaussianblur result="blur" stddeviation="3"/>
                        <feflood/>
                        <fecomposite in2="blur" operator="in"/>
        ...
        <section class="numbers">
            <div class="block-number">
                <div class="block1 number-black1"><span>6</span></div>
                <div class="block number-black2"><span>лет успешной работы</span></div>
                <div class="block number-orange1"></div>
                <div class="block number-orange2"></div>
                <div class="block number-orange3"></div>
                <div class="block number-orange4"></div>
                <div class="block number-orange5"></div>
                <div class="block number-orange6"></div>
                <div class="block number-orange7"></div>
            </div>
            <div class="block-number1">
                <div class="block1 number-black3"><span>10</span></div>
                <div class="block3 number-black4"><span>крутых специалистов</span></div>
                <div class="block3 number-orange8"></div>
                <div class="block3 number-orange9"></div>
                <div class="block3 number-orange10"></div>
                <div class="block3 number-orange11"></div>
            </div>
            <div class="block-number2">
                <div class="block5 number-black5"><span>успешно реализованных проэктов </span></div>
                <div class="block1 number-black6"><span>100+</span></div>
                <div class="block5 number-orange12"></div>
                <div class="block5 number-orange13"></div>
                <div class="block5 number-orange14"></div>
                <div class="block5 number-orange15"></div>
            </div>
            <div class="new-block-number">
                <div class="number-black-new"><span>6</span></div>
                <div class="number-black-new2"><span>лет успешной работы</span></div>

                <div class="number-black-new3"><span>10</span></div>
                <div class="number-black-new4"><span>крутых специалистов</span></div>

                <div class="number-black-new5"><span>100+</span></div>
                <div class="number-black-new6"><span>успешно реализованных проэктов </span></div>
            </div>
        </section>
        <section class="for-fun">
            <div class="main-logo">
                <svg xmlns="http://www.w3.org/2000/svg" width="278" height="62.944" viewbox="0 0 278 62.944">
                <defs>
                    <style>
                        .cls-1{
                            fill:#fff;
                ...
                <g id="Logo_RD" transform="translate(-827 -2748)">
                    ...
                    <path id="Контур_34" d="M374.162 907.724v8.118h-6.372c-5.936 0-9.558-3.622-9.558-9.6v-10.128H353.3v-2.182l12.046-12.832h1.92v7.856h6.765v7.114h-6.5v8.555a2.866 2.866 0 0 0 3.1 3.1z" class="cls-3" transform="translate(558.252 1868.733)"/>
                    <path id="Контур_33" d="M307.672 925.731c-7.332 0-11.784-3.884-11.872-9.689h8.9c0 1.964 1.353 2.881 3.142 2.881 1.353 0 2.619-.7 2.619-2.095 0-1.571-2.051-2.008-4.626-2.4-4.146-.655-9.689-1.92-9.689-8.467 0-5.368 4.583-8.86 11.479-8.86 6.852 0 11.26 3.623 11.391 9.078h-8.685c0-1.7-1.135-2.531-2.837-2.531-1.484 0-2.488.742-2.488 1.964 0 1.528 2.051 1.877 4.626 2.357 4.234.742 9.907 1.659 9.907 8.467 0 5.63-4.714 9.3-11.871 9.3z" class="cls-3" transform="translate(591.885 1859.717)"/>
                    <path id="Контур_32" d="M220.4 911.416c0-8.336 6.285-14.316 15.058-14.316 8.729 0 15.058 5.979 15.058 14.316 0 8.293-6.329 14.316-15.058 14.316-8.773-.001-15.058-6.024-15.058-14.316zm20.862 0a5.809 5.809 0 1 0-5.8 6.023 5.674 5.674 0 0 0 5.8-6.023z" class="cls-3" transform="translate(637.632 1859.717)"/>
                    ...
                    <path id="Контур_38" d="M796.3 884.843v28.631h9.253V876.9h-1.266z" class="cls-3" transform="translate(299.447 1871.1)"/>
                    <path id="Контур_37" d="M744.059 897.929v26.885H736.9l-.786-1.92a12.623 12.623 0 0 1-8.114 2.794c-8.205 0-14.1-5.979-14.1-14.359 0-8.336 5.892-14.228 14.1-14.228a12.687 12.687 0 0 1 8.205 2.88l.96-2.095h6.9zm-8.816 13.486a6.024 6.024 0 1 0-6.023 6.11 5.9 5.9 0 0 0 6.023-6.109z" class="cls-3" transform="translate(345.883 1859.717)"/>
                    <path id="Контур_36" d="M681.163 907.724v8.118h-6.373c-5.936 0-9.558-3.622-9.558-9.6v-10.128H660.3v-2.182l12.046-12.832h1.92v7.856h6.765v7.114h-6.5v8.555a2.866 2.866 0 0 0 3.1 3.1z" class="cls-3" transform="translate(378.494 1868.733)"/>
                    <path id="Прямоугольник_19" d="M0 0H9.253V26.885H0z" class="cls-3" transform="translate(1027.501 2757.689)"/>
                    <path id="Контур_39" d="M576.583 898.029h-2.095l-1.178 2.27a12.866 12.866 0 0 0-8.467-3.1A13.173 13.173 0 0 0 551.4 910.73a13.656 13.656 0 0 0 3.361 9.166 12.92 12.92 0 0 0 6.416 3.884 14.557 14.557 0 0 0 3.666.48 13.334 13.334 0 0 0 7.027-2.008v.786c0 3.186-2.488 5.15-5.587 5.15-2.27 0-4.539-.96-5.194-2.75h-1.571l-5.106 5.107c2.488 3.23 6.678 5.106 11.959 5.106 8.86 0 14.4-5.237 14.4-13.661v-23.873zm-7.769 18.026a5.715 5.715 0 0 1-2.444.524 5.488 5.488 0 0 1-5.15-3.186 6.01 6.01 0 0 1-.567-2.706 5.583 5.583 0 0 1 5.717-5.848 5.6 5.6 0 0 1 5.718 5.848 6.814 6.814 0 0 1-.567 2.706 5.534 5.534 0 0 1-2.706 2.662z" class="cls-3" transform="translate(441.971 1859.66)"/>
                    <path id="Прямоугольник_18" d="M0 0H9.253V26.885H0z" class="cls-3" transform="translate(981.145 2757.689)"/>
                    <path id="Контур_31" d="M162.394 905.08H158.9v10.649h-9.6V880.9h15.1c7.507 0 12.963 5.063 12.963 12.352a11.112 11.112 0 0 1-5.543 9.82l6.94 12.657h-10.693zm-3.492-8.118h4.365c2.662 0 4.234-1.615 4.234-3.8s-1.528-3.753-4.234-3.753H158.9z" class="cls-3" transform="translate(677.7 1868.846)"/>
                    <path id="Контур_35" d="M468.879 898.271c0 10.169-7.463 17.458-17.982 17.458H436.8V880.9h14.1c10.56-.044 17.979 7.2 17.979 17.371zm-9.82 0c0-5.15-3.448-8.6-8.6-8.6h-4.015v17.284h4.015c5.152-.043 8.6-3.534 8.6-8.684z" class="cls-3" transform="translate(509.087 1868.846)"/>
                </g>
                </svg>
            </div>
            <div class="item" id="tria-first">
                <svg class="triangle-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="29.665" viewbox="0 0 31 29.665">
                <defs>
                ...
                <g filter="url(#lds6bnv9xa)">
                    <path fill="none"  stroke-linecap="round" stroke-linejoin="round" stroke-width="3px" d="M286.848 376.1l-2.5-4.33-2.5 4.332-2.5 4.333h10z" transform="translate(-268.85 -361.27)"/>
                </g>
                </svg>
                <span class="ui">UI/UX design</span>
            </div>
            <div class="item" id="tria-second">
                <svg class="triangle-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="29.665" viewbox="0 0 31 29.665">
                <defs>
                    <filter id="lds6bnv9xa1" width="31" height="29.665" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset/>
                        <fegaussianblur result="blur" stddeviation="3"/>
            ...
            <div class="item" id="sq-first">
                <svg class="square-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewbox="0 0 31 31">
                <defs>
                ...
                <g filter="url(#f1jaslyowa)">
                    <path fill="none"  stroke-linecap="round" stroke-linejoin="round" stroke-width="3px" d="M0 0h10v10H0z" transform="translate(10.5 10.5)"/>
                </g>
                </svg>
                <span class="ui">UI/UX design</span>
            </div>
            <div class="item" id="sq-second">
                <svg class="square-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewbox="0 0 31 31">
                <defs>
                    <filter id="f1jaslyowa1" width="31" height="31" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset/>
                        <fegaussianblur result="blur" stddeviation="3"/>
            ...
            <div class="item" id="ci-first">
                <svg class="circle-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewbox="0 0 31 31">
                <defs>
                ...
                <g filter="url(#kgr2cn6dba)">
                    <path fill="none"  stroke-linecap="round" stroke-linejoin="round" stroke-width="3px" d="M359.141 270.315a5 5 0 1 1-5-5 5 5 0 0 1 5 5z" transform="translate(-338.64 -254.82)"/>
                </g>
                </svg>
                <span class="ui">UI/UX design</span>
            </div>
            <div class="item" id="ci-second">
                <svg class="circle-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewbox="0 0 31 31">
                <defs>
                    <filter id="kgr2cn6dba1" width="31" height="31" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset/>
                        <fegaussianblur result="blur" stddeviation="3"/>
            ...
            <div class="item" id="cr-first">
                <svg class="cross-keis" xmlns="http://www.w3.org/2000/svg" width="33.387" height="33.387" viewbox="0 0 33.387 33.387">
                <defs>
            ...
            <div class="item" id="cr-second">
                <svg class="cross-keis" xmlns="http://www.w3.org/2000/svg" width="33.387" height="33.387" viewbox="0 0 33.387 33.387">
                <defs>
                    <filter id="nln5f4lmia2" width="33.387" height="33.387" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset/>
                        <fegaussianblur result="blur" stddeviation="3"/>
            ...
            <div class="item" id="cr-third">
                <svg class="cross-keis" xmlns="http://www.w3.org/2000/svg" width="33.387" height="33.387" viewbox="0 0 33.387 33.387">
                <defs>
                    <filter id="nln5f4lmia21" width="33.387" height="33.387" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset/>
                        <fegaussianblur result="blur" stddeviation="3"/>
                        <fecomposite in2="blur" operator="in"/>
                        <fecomposite in="SourceGraphic"/>
            ...
            <div class="item" id="tria-third">
                <svg class="triangle-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="29.665" viewbox="0 0 31 29.665">
                <defs>
                    <filter id="lds6bnv9xa11" width="31" height="29.665" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset/>
                        <fegaussianblur result="blur" stddeviation="3"/>
            ...
            <div class="item" id="ci-third">
                <svg class="circle-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewbox="0 0 31 31">
                <defs>
                    <filter id="kgr2cn6dba11" width="31" height="31" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset/>
                        <fegaussianblur result="blur" stddeviation="3"/>
            ...
            <div class="item" id="sq-third">
                <svg class="square-keis" xmlns="http://www.w3.org/2000/svg" width="31" height="31" viewbox="0 0 31 31">
                <defs>
                    <filter id="f1jaslyowa11" width="31" height="31" x="0" y="0" filterunits="userSpaceOnUse">
                        <feoffset/>
                        <fegaussianblur result="blur" stddeviation="3"/>
